...
-- ----------------------------
INSERT INTO `jfw_admin` VALUES ('1', 'root', '319d732120b54b55edac87950cea9263', 'ABCD', '1463059312', '1463063473');
INSERT INTO `jfw_admin` VALUES ('2', 'admin', '319d732120b54b55edac87950cea9263', 'ABCD', '1463059312', '1463059312');
...
CREATE TABLE `jfw_node` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='权限规则表';
...
INSERT INTO `jfw_node` VALUES ('4', 'Admin/Member/memberList', '权限', '1', '0', '0', '1463057637', '1463057637');
