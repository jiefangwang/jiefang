...
<div  style="position:relative;">
           ...
           <div class="content">
            <div class="first_screen">
               ...
               <div class="welcome_wz">
                    <!-- <img src="/jiefang/Public/Admin/Image/welcome_wz.png" width="400" height="112" /> -->
                    <div>
                        欢迎进入<br/>
                        街坊网后台管理系统
                    </div>
        ...
        <div class="page1">
           <div class="content">
            <div class="second_screen">
               <ul>
                <li>
                    <a href="javascript:;" onclick="parent.addTab('/jiefang/index.php/Admin/Member/memberList','管理员')" title="管理员">
                        <span>
                            <img src="/jiefang/Public/Admin/Image/icon_1.png" width="56" height="61" />
                        </span>
                        <p>管理员</p>
                    </a>
                </li>
   ...
   <div class="main_desktop">
    <ul class="desktop_wrap">
       <li>
        <p>通讯录</p>
        <a href="javascript:;" onclick="window.top.addTab('list.html','通讯录');return false;"><img src="/jiefang/Public/Admin/Image/icon_2.png" width="56" height="58" /></a></li>
       <li>
        <p>工作任务</p>
 ...
 <style type="text/css">
    .welcome_wz div{font-size:40px;color:white;width:400px;height:112px;font-weight:bold;text-align:center;}
 </style>
</body>
</html>